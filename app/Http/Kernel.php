...
class Kernel extends HttpKernel
{
    ...
    protected $middlewareAliases = [
        ...
        'unit_access' => \App\Http\Middleware\UnitAccess::class,
        'admin_unit_access' => \App\Http\Middleware\AdminUnitAccess::class,
        'admin_access' => \App\Http\Middleware\AdminAccess::class,
        'not_unit_access' => \App\Http\Middleware\NotUnitAccess::class,
    ];
}
