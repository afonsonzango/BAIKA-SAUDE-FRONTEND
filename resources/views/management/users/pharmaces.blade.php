...
<div class="pagetitle">
    ...
    <nav>
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">Farmácias</li>
      </ol>
    </nav>
  </div><!-- End Page Title -->
        ...
        <div class="card">
          <div class="card-body">
            ...
            <table class="table datatable">
              ...
              <tbody>
                @foreach ($pharmaces as $index => $pharmace)
                <tr>
                  <td scope="" style="width: 15px"><input type="checkbox"></td>
                  <th scope="row" style="width: 10px">{{++$index}}</th>
                  <td style="width: 10px"><img src="" alt=""></td>
                  <td>{{$pharmace["name_unity_organic"]}}</td>
                  <td>{{$pharmace["phoneNumber"]}}</td>
                  <td>{{$pharmace["province"]}},{{$pharmace["municipality"]}},{{$pharmace["street"]}}</td>
                  <td>{{$pharmace["description"]}}</td>
    ...
    <div class="modal-dialog modal-dialog-centered">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title">Registar Farmácia</h5>
